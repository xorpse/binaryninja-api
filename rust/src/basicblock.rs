...
unsafe impl<'a, 'b: 'a, C: 'b + BlockContext> CoreArrayWrapper<'a> for Edge<'b, C> {
    type Wrapped = Edge<'b, C>;

    unsafe fn wrap_raw(raw: &'a Self::Raw, context: &'a Self::Context) -> Edge<'b, C> {
